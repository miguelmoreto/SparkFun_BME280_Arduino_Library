...
class BME280
{
  ...
  int32_t readFloatPressure( void ); // divide by 256.0 to obtain float.
  #if 0
	float readFloatAltitudeMeters( void );
	float readFloatAltitudeFeet( void );
	#endif
	int32_t readFloatHumidity( void ); // divide by 1024.0 to obtain float.

	//Temperature related methods
  int32_t readTempC( void ); // divide by 100 to obtain float.
  //int32_t readTempF( void );
