...
void BME280::set_mode(uint8_t mode)
{
	...
	dataToWrite |= (settings.pressOverSample << 0x02) & 0x1C;
	//Last, set mode
	dataToWrite |= (settings.runMode) & mode;
	//Load the byte
	writeRegister(BME280_CTRL_MEAS_REG, dataToWrite);
}
...
//
//****************************************************************************//
int32_t BME280::readFloatPressure( void )
{
...
//
//****************************************************************************//
int32_t BME280::readFloatHumidity( void )
{
